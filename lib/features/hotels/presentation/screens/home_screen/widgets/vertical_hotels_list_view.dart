...
//                     IconButton(
//                         onPressed: () {
//                           AppCubit.get(context).updateBooking(type: 'completed', bookingId: AppCubit.get(context).cancelled[index].id!, token: CacheHelper.getData(key: 'toKen'));
//
//                         },
//                         icon: const Icon(
...
//                     IconButton(
//                         onPressed: () {
//                           AppCubit.get(context).updateBooking(type: 'cancelled', bookingId: AppCubit.get(context).cancelled[index].id!, token: CacheHelper.getData(key: 'toKen'));
//
//                         },
//                         icon: const Icon(
