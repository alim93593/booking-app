...
class AuthRepositoryImpl extends AuthRepository {
  ...
  @override
  Future<Either<Failure, User>> registerUser({required String email, required String password, required String name, required String passwordConfirm}) {
    // TODO: implement registerUser
    throw UnimplementedError();
  }

  @override
  Future<Either<Failure, User>> updateProfileInfo({required String email, required String token, required String name, required String image}) {
